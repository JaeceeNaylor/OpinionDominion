...
def calculate_scores(all_reviews):
    ...
    print()
    target_recall, target_precision = calcuate_target_recall_precision_exact_match(all_reviews)
    target_fmeasure = fmeasure_score(target_recall, target_precision)
    print(f'TARGET EXACT RECALL: {target_recall}')
    print(f'TARGET EXACT PERECISION: {target_precision}')
    print(f'TARGET EXACT F-MEASURE: {target_fmeasure}')
    print()
